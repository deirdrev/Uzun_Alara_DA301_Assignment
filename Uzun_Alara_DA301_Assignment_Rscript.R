...
## Our findings indicate that global sales surpass North American and European 
## sales, with Europe having the smallest share among them.
## In terms of sales by platform, the analysis shows that PC, PS3, and X360 
## dominate the market, with Wii also being a strong contender. 
...
# All sales data's kurtosis value is more than 3, indicates a mesokurtic
...
# The histograms of sales by platform and boxplot graphs consistently showed
# that global sales are the highest, confirming our previous findings. 
# To assess the normality of the sales data, we created Q-Q plots and conducted
# Shapiro-Wilk tests. With p-values < 0.05 for all sales, we conclude that 
# the data is not normally distributed. Additionally, all sales data exhibits 
# positive skewness, indicating that the majority of the products have 
# lower sales, while a few products have exceptionally high sales.
